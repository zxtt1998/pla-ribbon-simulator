...
let selected=[], filter='all', query='', profile='officer-command', force='army', dragId=null, selectionSequence=0, repeatInputTimer=null, nameZh='姓名', namePinyin='XING MING', rankGroup='officer', rankId='';
